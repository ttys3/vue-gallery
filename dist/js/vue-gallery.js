(function (global, factory) {
  ...
  var __vue_staticRenderFns__ = [];
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-3fc2b680_0", { source: ".blueimp-gallery>.description{position:absolute;top:30px;left:15px;color:#fff;display:none}.blueimp-gallery-controls>.description{display:block}", map: undefined, media: undefined });
